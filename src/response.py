...
def helpResponse(ctx, args):
    ...
    if ctx.message.channel.id in allowedChannels:
        ...
        if args == "help":
            ...
            embed.add_field(
                name="Description", value="Allows for feedback on the bot, positive/negative, and what could be changed about the bot, but don't get it confused with `!suggest` command.", inline=False)
            embed.add_field(
                name="Usage", value="`!feedback \"[feedback]\"` - [feedback] argument being what positive/negative thoughts you have about the bot.")
            embed.add_field(
                name="Example", value="`!feedback \"I really like how this bot helps the community, but I would like to see more questions/answers :(\"`", inline=False)
            ...
            embed.add_field(
                name="Usage", value="`!suggest \"[question]\" \"[answer]\"` - [question] argument of course being the question you think we are missing, and [answer] argument (optional) which is your beautifully written answer to the specified question which will help the community in incoming years :)")
